                            ...
                            {{ csrf_field() }}
                                <div class="input-group">
                                    ...
                                    <div class="form-line {{ $errors->has('name') ? ' error' : '' }}">
                                        <input type="text" class="form-control" name="name" value="{{old('name')}}" placeholder="Name" required autocomplete="new-password">
                                    </div>
                                    @if ($errors->has('email'))
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="form-line {{ $errors->has('email') ? ' error' : '' }}">
                                        <input type="text" class="form-control" name="email" value="{{old('email')}}" placeholder="Email Address" required autocomplete="new-password">
                                    </div>
                                    @if ($errors->has('email'))
