<section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="{{asset('bsbmd/images/user.png')}}" width="40" height="40" alt="User" />
                </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li {{starts_with(Route::currentRouteName(),'questionnaire')? 'class=active':''}}>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2018 <a href="javascript:void(0);">Buah Hati</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.4
                </div>
